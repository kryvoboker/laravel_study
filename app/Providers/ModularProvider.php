...
class ModularProvider extends ServiceProvider
{
                ...
                foreach ($modules as $mod => $submodules) {
                    foreach ($submodules as $key => $sub) {
                        ...
                        Route::middleware('web')
                            ->group(
                                function () use ($mod, $sub, $relativePath, $path) {
    ...
    private function getWebRoutes($mod, string $sub, string $relativePath, string $path)
    {
    ...
    private function getApiRoutes($mod, string $sub, string $relativePath, string $path)
    {
